...
### findObjectValue : \_.findObjectValue(object,key)

Returns the value of the key in the object. Works even if object is a nested one. Returns null if no such object exists!
